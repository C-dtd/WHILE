...
async function postJoin() {
    ...
    const uploadFileInput = document.querySelector('#profile-img');
    let imgId;
...
// 프로필 미리보기
document.querySelector('#profile-img').addEventListener('change', function(event) {
    ...
    if (file) {
        ...
        previewImg.src = '../static/img/anonymous.webp';
    }
});

function delimg() {
    document.querySelector('#profile-preview-img').src = '../static/img/anonymous.webp';
